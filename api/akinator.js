...
module.exports = async (req, res) => {
  ...
  try {
    if (action === 'start') {
      // Iniciar jogo
      const init = await fetch('https://srv12.akinator.com:9162/new_session?callback=foo&partner=1&player=website&uid=&frontaddr=127.0.0.1&constraint=ETAT%3C%3E%22%22&lang=pt', {
        headers: { 'Accept': '*/*' }
      });
